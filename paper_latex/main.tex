...
\usepackage{url}
\usepackage{hyperref}
%\usepackage{balance}  % journal-only
\usepackage{pgf-pie}
...
\title{ClinicalMind: Real-Time Clinical NER via LLM Knowledge Distillation and FHIR-Aligned Summarization}

\author{%
\IEEEauthorblockN{Dhruv Dhankher}
\IEEEauthorblockA{Department of Computer Science and Engineering\\
RV College of Engineering\\
Bengaluru, India\\
dhruvdhankher.cs23@rvce.edu.in}
\and
\IEEEauthorblockN{Anuj Devpura}
\IEEEauthorblockA{Department of Computer Science and Engineering\\
RV College of Engineering\\
Bengaluru, India\\
anujdevpura.cs23@rvce.edu.in}
\and
\IEEEauthorblockN{Aditya Rukmangad}
\IEEEauthorblockA{Department of Computer Science and Engineering\\
RV College of Engineering\\
Bengaluru, India\\
adityarukmangad.cs23@rvce.edu.in}
\and
\IEEEauthorblockN{Vijaya Kumar}
\IEEEauthorblockA{Assistant Professor, Department of Computer Science\\
and Engineering\\
RV College of Engineering\\
Bengaluru, India\\
vijayakumar@rvce.edu.in}
}
...
Clinical documentation is among the most time-intensive
